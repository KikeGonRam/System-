```html
   ...
   <div class="container mx-auto p-6 bg-white rounded-xl shadow-lg max-w-md">
       <h1 class="text-3xl font-bold text-blue-700 mb-6 animate-title text-center">Crear Grupo</h1>
       @if ($errors->any())
       ...
       <form action="{{ route('admin.groups.store') }}" method="POST">
           ...
           <button type="submit" class="w-full bg-blue-600 text-white font-semibold py-2 rounded-lg hover:bg-blue-700 transition duration-300">Crear Grupo</button>
       </form>
   </div>
   @endsection
   ```