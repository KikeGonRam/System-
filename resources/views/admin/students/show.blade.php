        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-white">Detalles del Alumno</h1>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col md:flex-row gap-6 mb-8">
                    ...
                    <div class="flex-shrink-0">
                        <div class="relative">
                            <img src="{{ $student->photo_url ?? asset('images/default-student.png') }}" alt="{{ $student->name }}" class="w-32 h-32 rounded-full object-cover border-4 border-blue-100 mx-auto">
                            <span class="absolute bottom-0 right-0 bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded-full">{{ $student->edad }} años</span>
                        </div>
                    </div>
                    ...
                    <div class="flex-grow">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xl font-semibold text-gray-900">{{ $student->name }}</p>
                            </div>
                            
                            <!-- Email -->
                            <div>
                                <h3 class="text-sm font-medium text-gray-500">Correo Electrónico</h3>
                                <p class="mt-1 text-lg text-gray-900 break-all">{{ $student->email }}</p>
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="mt-1 text-gray-900">
                                ...
                                <span class="text-sm text-gray-500 ml-2">({{ $student->created_at->diffForHumans() }})</span>
                            </p>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="mt-1 text-gray-900">
                                ...
                                <span class="text-sm text-gray-500 ml-2">({{ $student->updated_at->diffForHumans() }})</span>
                            </p>
                        </div>
                    </div>
                </div>
